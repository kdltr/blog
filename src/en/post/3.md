...
These is also where we added the first work in progress character to the game.
...
since there was no bindings for the Renderer API yet.
...
(CHICKEN is know to work on windows, the SDL library is designed to be highly portable…).
...
To make sure everything worked, I just had to start the game in the Wine implementation of windows.
...
as changes mainly were many tiny ones.
...
[<img class="fill" alt="prototype screenshot" src="/projects/cphys2015/prototype-screenshot5.png"/>]
(/projects/cphys2015/prototype-screenshot5.png)

Taking care of our character was our next big step.

Our artist drew a colored version of it,
made multiple faces and bodies so we could integrate simple animations.
...
A lot of people thing the game is very hard, even at the beginning of the 
...
With the sounds and music finally in place, we could release the game at last!
