...
At this points, crepes were represented as a list of the column-line position,
as well as the last time stamp at which they moved to calculate the next time they will descend.
...
First roughly (**v1.0~81**) then we added some random speed and dropping (**v1.0~79**).
